...
const milestones = [
  ...
  },
  {
    ...
    title: 'SDC Workshop',
    metric: '40+',
    metricLabel: 'Live participants',
    desc: 'Delivered "Software Architecture in the Age of AI" workshop, live-demoed Avylo to active engineering audience. Standing ovation.',
    color: '#44c4f6',
  },
  {
    icon: <Users size={22} />,
    ...
    metric: '120+',
    metricLabel: 'Validated founders',
    desc: 'Direct conversations with founding teams across Tunisia, France, Germany, and Canada. Consistent pain point confirmation.',
    color: '#34d399',
  },
  {
